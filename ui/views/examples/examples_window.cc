...
class ExamplesWindowContents : public WidgetDelegateView,
 ...
 private:
  ...
  void InitExamplesWindow() {
    ...
    column_set->AddColumn(GridLayout::LEADING, GridLayout::LEADING, 0, GridLayout::USE_PREF, 0, 0);
    column_set->AddPaddingColumn(0, 5);
    ...
    ColumnSet* column_set1 = layout->AddColumnSet(1);
    column_set1->AddPaddingColumn(0, 5);
    column_set1->AddColumn(GridLayout::FILL, GridLayout::FILL, 1,
                          GridLayout::USE_PREF, 0, 0);
    column_set1->AddPaddingColumn(0, 5);
